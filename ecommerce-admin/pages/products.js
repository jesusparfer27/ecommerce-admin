import { useEffect, useState } from "react"; // Agregando useState
...
export default function Products() {
    ...
    return (
        <Layout>
            <Link className="bg-blue-900 text-black rounded-md py-1 px-2" href={'/products/new'}>
                Add new product
            </Link>
            <table className="basic mt-2">
                ...
                <tbody>
                    {products.map(product => (
                        <tr key={product._id}> {/* Agregado key para evitar warnings */}
                            <td>{product.title}</td>
                            <td>
